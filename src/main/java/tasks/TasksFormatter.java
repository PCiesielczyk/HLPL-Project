...
public class TasksFormatter {
    ...
    public static void deleteTaskList(String taskListId) throws GeneralSecurityException, IOException {

        Tasks.Tasklists.Delete delete = getService().tasklists().delete(taskListId);
        delete.execute();
    }
